...
def _init_():
    ...
    if not args.eval:
        ...
        os.system('cp model/CWNet_cls.py checkpoints' + '/' + args.exp_name + '/' + 'CWNet_cls.backup')
        os.system('cp util.CWNet_util.py checkpoints' + '/' + args.exp_name + '/' + 'CWNet_util.backup')
...
def train(args, io):
    ...
    if args.use_sgd:
        print("Use SGD")
        opt = optim.SGD(model.parameters(), lr=0.1, momentum=args.momentum, weight_decay=1e-4)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='checkpoints/32121++/best_model.t7', metavar='N',
